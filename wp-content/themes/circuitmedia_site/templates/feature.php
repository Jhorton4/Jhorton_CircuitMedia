...
<div class="column third">
    <a class="feature-image-overlay" href="<?php the_permalink(); ?>"><img src="<?php the_field('ability_feature_image'); ?>" /></a>
    <a href="<?php the_permalink(); ?>"<h3><?php the_title(); ?></h3></a>
    <p><?php the_field('work_short_description'); ?></p>
 </div>
